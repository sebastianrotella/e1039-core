...
#ifndef _KALMANFASTTRACKING_OLD_H
#define _KALMANFASTTRACKING_OLD_H
...
{
public:
    explicit KalmanFastTracking_OLD(const PHField* field, const TGeoManager *geom, bool flag = true);
    ~KalmanFastTracking_OLD();
